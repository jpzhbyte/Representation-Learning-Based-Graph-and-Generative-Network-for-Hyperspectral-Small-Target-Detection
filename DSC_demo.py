...
def readData(data_no):
    ...
    '''
    if data_no == 0:
        path = 'sandiego_plane.mat'
        target_prior_coordinates = (22, 69)
        Kt = 50
    elif data_no == 1:
        path = 'HYDICE_data.mat'
        target_prior_coordinates = (65, 36)
        Kt = 130
    elif data_no == 2:
        path = 'abu-urban-1.mat'
        target_prior_coordinates = (7, 25)
        Kt = 150
    elif data_no == 3:
        path = 'abu-urban-2.mat'
        target_prior_coordinates = (22, 69)
        Kt = 150
    elif data_no == 4:
        path = 'abu-urban-4.mat'
        target_prior_coordinates = (22, 69)
        Kt = 135
    elif data_no == 5:
        path = 'Segundo_gai.mat'
        target_prior_coordinates = (65, 36)
        Kt = 150
    elif data_no == 6:
        path = './/Data/HYDICE.mat'
        target_prior_coordinates = (7, 25)
        Kt = 150
    elif data_no == 7:
        path = './/Data/HYDICE.mat'
...
def dictionaryConstruction(X, p, Kt, m=15, n=70):
    '''
...
if __name__ == '__main__':
    ...
    sio.savemat('.//results//DSC.mat', {'DSC': detection_map})
