...
def initialize_parameters():
    ...
    x_w1 = tf.get_variable("x_w1", [205,256], initializer = tf.contrib.layers.xavier_initializer(seed = 1))#创建新的tensorflow变量
...
Train_X = scio.loadmat('.\Input\ABU4\Train_X.mat')
TrLabel = scio.loadmat('.\Input\ABU4\TrLabel.mat')
Test_X = scio.loadmat('.\Input\ABU4\Test_X.mat')
TeLabel = scio.loadmat('.\Input\ABU4\TeLabel.mat')
Train_L = scio.loadmat('.\Input\ABU4\Train_L.mat')
Test_L = scio.loadmat('.\Input\ABU4\Test_L.mat')
